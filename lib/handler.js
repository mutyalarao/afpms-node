...
TblMap.prototype.addMap=function(jCol,dCol){
 this.map[jCol]=dCol; 
}
...
TblMap.prototype.showMap=function(){
 ...
 {
   console.log(arr[i]+","+this.map[arr[i]]);
 }
}
var x=new TblMap('vet','vet_tbl');

//x.addMap('vetName','vet_name');
//x.addMap('serviceNum','service_num');
//x.showMap();
