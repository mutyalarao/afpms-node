...
var x=new TblMap('vetTbl','veteran_tbl');

x.addMap('serviceNum',{'dCol':'service_num'
                   ,'type':'NUM'});
x.addMap('memNum',{'dCol':'mem_num'
                   ,'type':'NUM'});
x.addMap('fName',{'dCol':'first_name'
                   ,'type':'CHAR'});
x.addMap('lName',{'dCol':'last_name'
                   ,'type':'CHAR'});
x.addMap('address1',{'dCol':'address1'
                   ,'type':'CHAR'});
x.addMap('address2',{'dCol':'address2'
                   ,'type':'CHAR'});
x.addMap('address3',{'dCol':'address3'
                   ,'type':'CHAR'});
x.addMap('city',{'dCol':'city'
                   ,'type':'CHAR'});
x.addMap('state',{'dCol':'city'
                   ,'type':'CHAR'});
x.addMap('pinCode',{'dCol':'pin_code'
                   ,'type':'NUM'});
x.addMap('trade',{'dCol':'trade'
                   ,'type':'CHAR'});
x.addMap('joinDt',{'dCol':'join_dt'
                   ,'type':'DATE'});
x.addMap('deathDt',{'dCol':'death_dt'
                   ,'type':'DATE'});
x.addMap('birthDt',{'dCol':'birth_dt'
                   ,'type':'DATE'});
x.addMap('dischargeDt',{'dCol':'discharge_dt'
                   ,'type':'DATE'});
x.addMap('forceType',{'dCol':'force_type'
                   ,'type':'CHAR'});

x.addMap('enrollDt',{'dCol':'enroll_dt'
                   ,'type':'DATE'});
